...
export function AuroraField() {
    return (
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <motion.div
                className="absolute left-[8%] top-[12%] h-56 w-56 rounded-full bg-violet-400/14 blur-3xl"
                animate={{ x: [0, 45, 0], y: [0, 24, 0], scale: [1, 1.08, 1] }}
                transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
                className="absolute bottom-[8%] right-[12%] h-72 w-72 rounded-full bg-sky-400/12 blur-3xl"
